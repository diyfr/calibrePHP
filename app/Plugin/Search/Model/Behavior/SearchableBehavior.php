 ...
 */
	public function validateSearch(Model $Model, $data = null) {
		...
		if (! is_null($Model->data)){ // EDIT 2016-08-20
 ...
 */
	protected function _connectedLike($value, $field, $fieldName) {
		...
		//$orValues  = String::tokenize($value, $field['connectorOr']); EDIT 2016-08-20
		foreach ($orValues as $orValue) {
			//$andValues = String::tokenize($orValue, $field['connectorAnd']); EDIT 2016-08-20
